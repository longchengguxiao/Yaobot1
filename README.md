...
+ 生态
  +  [单词系统](#单词系统)——学习使我快乐
  +  [留言系统](#留言系统)——用的人少得可怜，不过会多的，对吧？
  +  [账单系统](#账单系统)——只有本人在使用的系统
  +  [查询系统](#查询系统)——方便你我他
  +  [娱乐系统](#娱乐系统)——群内活跃气氛小助手
  +  [你懂的系统](#你懂的)——不要一上来就点开这个啊喂！！！
  +  [恶意系统](#恶意系统)——最不想开启但却又很好奇
  +  [宠物系统](#宠物系统)——测试中！
  +  [群聊系统](#群聊系统)——看起来十分有用的样子呢
  +  [人工智能系统](#人工智能)——有待开发
  +  [超级管理](#超级管理)——便于维护bot
     + [黑名单](#黑名单)
       + [模块管理](#模块管理)
         + [bug提交反馈](#bug反馈)
  +  [被大家嫌弃的功能](#小黑屋)——被拖入小黑屋的功能
...
##### 百度百科（感谢[baike_api](https://github.com/1MLightyears/baike)）
...
|   [关键字/格式](#关键字/格式)    |    [权限](#权限)     |                    [描述](#描述)                     | [备注](#备注) |
| :------------------------------: | :------------------: | :--------------------------------------------------: | :-----------: |
|        “梦的解析”/“解梦”         |  仅群聊(黑名单除外)  |               交互式对话，返回梦境解析               |     无CD      |
|        “百度”/“百度搜索”         |  仅群聊(黑名单除外)  |             交互式对话，返回百度百科词条             |   CD为30sec   |
|        "番剧"/“番剧更新”         |        所有人        |                 返回今日番剧更新列表                 |     无CD      |
|        “火星语”/“火星文”         |        仅群聊        |            交互式对话，返回翻译好的火星文            |     无CD      |
|    回复该链接并除去@后+占星术    |        仅群聊        |        返回该链接是否安全（安全，危险，未知）        |     无CD      |
|              “点歌”              |   仅群聊(除黑名单)   | 交互式对话，返回歌曲卡片（QQ音乐），暂不支持查询歌手 |   CD为20sec   |
|          “历史上的今天”          |        仅群聊        |       返回一个合并转发文本，内容为历史上的今天       |     无CD      |
| “我的词云”/”本群词云“/”词云总览“ | 分情况（黑名单除外） |         生成词云，根据命令不同生成不同的词云         |   CD为15sec   |
|              “翻译”              |        任何人        |           交互式对话，返回一条翻译后的文本           |     无CD      |
|        “天气”/“天气预报”         |        任何人        |           交互式对话，返回要查询地点的天气           |     无CD      |
|            “微博热搜”            |        仅群聊        |       返回一条微博热搜，成为人们茶余饭后的谈资       |     无CD      |
|        “功能”/“功能查询”         |        任何人        |                      查看本文档                      |     无CD      |
